        ...
        Vue.component("vue-apple-signin", {
            ...
            props: {
                ...
                type: {
                    ...
                    default: "sign in",
                    validator(value) {
                        return ["sign in", "sign up", "apple", "continue"].indexOf(value) > -1;
                    },
                },
            },
            computed: {
            ...
            mounted() {
                ...
                const { clientId: clientId, scope: scope, redirectURI: redirectURI, state: state } = options;
                if (!clientId) {
                ...
                window.AppleID.auth.init({ clientId: clientId, scope: scope, redirectURI: redirectURI, state: state });
            },
            render(createElement) {
                return createElement("div", { attrs: { id: this.id, "data-color": this.color, "data-border": this.dataBorder, "data-type": this.type } });
            },
        });
    },
};
